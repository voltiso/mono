...
// static_assert(
//   std::is_trivially_copyable_v<array::_::Impl<Options<option::Item<int>>>>);
// static_assert(
...
// struct VOLTISO_RELOCATABLE(S) {
// 	storage::_::CustomNNR<Options<option::Item<int>>> storage;
...
// static_assert(is::_::builtinRelocatable<int>);
...
// static_assert(
//   is::_::builtinRelocatable<
//     array::Custom<Options<option::Item<int>,
//     option::Extents<ValuePack<3>>>>>);
// static_assert(is::_::builtinRelocatable<Array<int, 3>>);
...
TEST(Array, implicitMoveOnly) {
	...
	using Array = array::_::Impl<Options<
	  option::Item<MoveOnly>, option::Extents<ValuePack<3>>,
...
static_assert(
  is::_::builtinRelocatable<array::Custom<
    Options<option::Item<Relocatable>, option::Extents<ValuePack<3>>>>>);
