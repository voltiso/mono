import { CallableWithThis, Newable, Return } from "../function.js";
import { Instance } from "./Instance.js";

export function callableClass<
	Class extends Newable,
	Fun extends CallableWithThis<never[], unknown, Class>
>(Cls: Class, fun: Fun): Class & Fun {
	function Ctor(...args: ConstructorParameters<Class>): Instance<Class>;
	function Ctor(...args: Parameters<Fun>): Return<Fun>;

	function Ctor(
		...args: ConstructorParameters<Class> | Parameters<Fun>
	): Return<Fun> | Instance<Class> {
		if (typeof new.target === "undefined")
			return fun.call(Cls, ...args) as Return<Fun>;
