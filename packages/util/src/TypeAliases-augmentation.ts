...
export interface TypeAliases1<_1> extends TypeAliases2<_1, UNSET> {
	Echo1: [_1]
}

/** Augment with `2-ary` type aliases */
export interface TypeAliases2<_1, _2> extends TypeAliases3<_1, _2, UNSET> {
	Echo2: [_1, _2]
}

/** Augment with `3-ary` type aliases */
export interface TypeAliases3<_1, _2, _3> extends TypeAliases4<
	_1,
	_2,
	_3,
	UNSET
...
export interface TypeAliases4<_1, _2, _3, _4> extends TypeAliases5<
	_1,
	_2,
	_3,
	_4,
...
export interface TypeAliases5<_1, _2, _3, _4, _5> extends TypeAliases6<
	_1,
	_2,
	_3,
	_4,
...
export interface TypeAliases6<_1, _2, _3, _4, _5, _6> extends TypeAliases7<
	_1,
	_2,
	_3,
	_4,
...
export interface TypeAliases7<_1, _2, _3, _4, _5, _6, _7> extends TypeAliases8<
	_1,
	_2,
	_3,
	_4,
...
export interface TypeAliases8<
	...
	_7,
	_8,
> extends TypeAliases9<_1, _2, _3, _4, _5, _6, _7, _8, UNSET> {
