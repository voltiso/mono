...
import type { StylableJsxConstruct_ } from '../StylableJsxConstruct/StylableJsxConstruct.js'
import type { StylableJsxCall } from './AutoStylableJsxCall.js'
import type {
	IStylableJsxCall,
	StylableJsxCall_Infer,
} from './StylableJsxCall.js'
