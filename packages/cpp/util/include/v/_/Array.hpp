...
#include "v/_/ArrayConcatTraits.hpp"

#include "v/Handle"
#include "v/Object"
#include "v/RawArray"
#include "v/Slice"
#include "v/_/DynamicArray.forward.hpp"
// #include "v/_/String.forward.hpp"
#include "v/concepts/Options"
#include "v/is_trivially_relocatable"
#include "v/memory/Iterator"
#include "v/option/Item"
#include "v/option/NUM_ITEMS"
#include "v/option/STARTING_INDEX"
#include "v/tag/EXPLICIT_COPY"
#include "v/tag/EXPLICIT_COPY_CONSTEVAL"
...
public:
	...
	consteval Custom(std::initializer_list<Item> list) {
	...
	template <class... Args>
	static VOLTISO_FORCE_INLINE constexpr auto from(Args &&...args) {
		return Self{tag::EXPLICIT_COPY, std::forward<Args>(args)...};
	}
...
public:
	...
	auto operator<<(this auto &&self, Other &&other) { // Allow rvalue this
		...
		return Result::from(
		  tag::EXPLICIT_COPY, std::forward<decltype(self)>(self),
...
namespace VOLTISO_NAMESPACE {
template <class Options>
static constexpr auto is_trivially_relocatable<array::Custom<Options>> =
  is_trivially_relocatable<typename Options::template Get<option::Item>>;

template <class Item, std::size_t NUM_ITEMS>
static constexpr auto is_trivially_relocatable<Array<Item, NUM_ITEMS>> =
  is_trivially_relocatable<Item>;
} // namespace VOLTISO_NAMESPACE
