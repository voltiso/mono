...
#include "v/is_instantiated_from_same" // For kind checking in FilterOutKind
...
private:
	...
	static constexpr bool is_same_kind =
	  is_instantiated_from_same<OptionToFilterKindFor, Head>;
...
struct CheckIfKindExists<OptionToLookFor, TypeList<HeadOption, TailOptions...>>
    : std::conditional_t<
        is_instantiated_from_same<OptionToLookFor, HeadOption>, std::true_type,
