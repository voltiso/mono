...
// --- forward declarations for string::Custom and v::String
// Forward declarations
// Forward declarations of string::Custom and v::String
...
public:
	VOLTISO_FORCE_INLINE auto dynamic() const && -> auto {
		return VOLTISO_NAMESPACE::dynamicString::from(this->self());
	}
};
} // namespace VOLTISO_NAMESPACE::string
